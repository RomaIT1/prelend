;(function(){
	...
	if(adult_param === "1"){
		...
		div.innerHTML = '<div id="verification_overlay" class="verification_overlay"> <div class="verification"> <div class="plus18">18+</div> <h2>Подтверждение возраста</h2> <p>Есть ли Вам 18 лет?</p> <button id="btn_verification" class="btn_verification">Да</button> </div> </div>';
